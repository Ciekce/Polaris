...
namespace polaris
{
	...
	namespace uci
	{
		...
		{
			constexpr auto As = std::array { -16.47359643,  125.09292680, -150.78265049,  133.46169058 };
			constexpr auto Bs = std::array { -10.64392182,   68.80469735,  -98.63536151,  100.12391368 };
