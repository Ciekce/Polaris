...
#define S(Mg, Eg) TaperedScore{(Mg), (Eg)}
	...
	{
		// keep below 2000
		constexpr auto Pawn = S(154, 100);
		constexpr auto Knight = S(660, 275);
		constexpr auto Bishop = S(715, 278);
		constexpr auto Rook = S(932, 565);
		constexpr auto Queen = S(2108, 857);
